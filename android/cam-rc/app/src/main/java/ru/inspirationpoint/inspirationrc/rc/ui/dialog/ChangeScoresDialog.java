...
public class ChangeScoresDialog extends DialogFragment implements NumberPicker.OnValueChangeListener{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView textView = contentView.findViewById(R.id.left_fighter_name);
        textView.setText(leftFighterName);
        textView = contentView.findViewById(R.id.right_fighter_name);
        textView.setText(rightFighterName);

        NumberPicker np_left = contentView.findViewById(R.id.np_left_score);
        NumberPicker np_right = contentView.findViewById(R.id.np_right_score);

        np_left.setTextColor(!SettingsManager.getValue(CommonConstants.IS_DARK_THEME, false) ?
                getResources().getColor(R.color.textColorPrimary) : getResources().getColor(R.color.whiteCard));
        ...
        np_right.setTextColor(!SettingsManager.getValue(CommonConstants.IS_DARK_THEME, false) ?
                getResources().getColor(R.color.textColorPrimary) : getResources().getColor(R.color.whiteCard));
