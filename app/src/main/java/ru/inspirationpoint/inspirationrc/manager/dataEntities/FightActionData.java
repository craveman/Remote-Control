...
public class FightActionData implements Cloneable, Serializable {
    ...
    public static FightActionData createSetScoreLeft(long time, int period, Fighter fighter, int score, long systemTime, int phrase) {
        FightActionData action = new FightActionData();
    ...
    public static FightActionData createSetScoreRight(long time, int period, Fighter fighter, int score, long systemTime, int phrase) {
        FightActionData action = new FightActionData();
    ...
    public static FightActionData createSetPriorityLeft(long time, int period, Fighter fighter, long systemTime) {
        FightActionData action = new FightActionData();
    ...
    public static FightActionData createSetPriorityRight(long time, int period, Fighter fighter, long systemTime) {
        FightActionData action = new FightActionData();
    ...
    public static FightActionData createSetCardLeft(long time, int period, Fighter fighter, boolean isYellow, long systemTime) {
        FightActionData action = new FightActionData();
    ...
    public static FightActionData createSetCardRight(long time, int period, Fighter fighter, boolean isYellow, long systemTime) {
        FightActionData action = new FightActionData();
...
//        action.systemTime = comment;
    ...
    public enum ActionPeriod {Fight, Pause, Extra, Other}
}
