...
public class FightersAutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setBackgroundColor(!SettingsManager.getValue(Constants.IS_DARK_THEME, false) ?
        ...
        ((TextView) convertView.findViewById(R.id.text)).setTextColor(!SettingsManager.getValue(Constants.IS_DARK_THEME, false) ?
        ...
        ((TextView) convertView.findViewById(R.id.nick)).setTextColor(!SettingsManager.getValue(Constants.IS_DARK_THEME, false) ?
                mContext.getResources().getColor(R.color.textColorPrimary) : mContext.getResources().getColor(R.color.whiteCard));
        return convertView;
    }
