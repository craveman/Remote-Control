...
public class WeaponChooseDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ImageButton closeButton = (ImageButton) titleView.findViewById(R.id.close);
        closeButton.setVisibility(View.GONE);

        View contentView = inflater.inflate(R.layout.weapon_dlg, null);
        TextView epee = (TextView) contentView.findViewById(R.id.weapon_epee);
        TextView rapier = (TextView) contentView.findViewById(R.id.weapon_rapier);
        TextView saber = (TextView) contentView.findViewById(R.id.weapon_saber);
