...
public class InputDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mInputTextView = (EditText) contentView.findViewById(R.id.email_input);
        mInputTextView.setTextColor(!SettingsManager.getValue(Constants.IS_DARK_THEME, false) ?
                getResources().getColor(R.color.textColorPrimary) : getResources().getColor(R.color.whiteCard));
        if (!edit.equals("")) mInputTextView.setText(edit);

        TextView messageTv = (TextView) contentView.findViewById(R.id.input_message);
        messageTv.setTextColor(!SettingsManager.getValue(Constants.IS_DARK_THEME, false) ?
                getResources().getColor(R.color.textColorPrimary) : getResources().getColor(R.color.whiteCard));
