...
//        }
        ...
        AppCompatImageView view = (AppCompatImageView) findViewById(R.id.iv_about_logo);
        view.setImageResource(SettingsManager.getValue(Constants.IS_DARK_THEME, false) ?
        R.drawable.logo_dark : R.drawable.about_logo);

        TextView verTextView = (TextView) findViewById(R.id.about_app_ver);
        verTextView.setText(getString(R.string.about_app_ver, version));

        TextView instructionButton = (TextView) findViewById(R.id.about_app_instruction);
        instructionButton.setTextColor(SettingsManager.getValue(Constants.IS_DARK_THEME, false) ?
        ...
        TextView emailButton = (TextView) findViewById(R.id.about_app_email);
        ...
        TextView telegramButton = (TextView) findViewById(R.id.about_app_telegram);
    ...
    protected void onResume() {
        super.onResume();
        if (SettingsManager.getValue(Constants.LOCALE_CHANGED_FIELD, false)) {
            SettingsManager.setValue(Constants.LOCALE_CHANGED_FIELD, false);
