...
import ru.inspirationpoint.inspirationrc.ui.activity.FightActivity.CardStatus;
...
public class CardDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView text = (TextView) contentView.findViewById(R.id.left_fighter_name);
        text.setText(leftFighterName);
        text = (TextView) contentView.findViewById(R.id.right_fighter_name);
    ...
    private CardStatus nextStatus(CardStatus cardStatus) {
        switch (cardStatus) {
            case CardStatus_None:
                return CardStatus.CardStatus_NonePlus;

            case CardStatus_NonePlus:
                return CardStatus.CardStatus_None;

            case CardStatus_Yellow:
                return CardStatus.CardStatus_YellowPlus;
        }
